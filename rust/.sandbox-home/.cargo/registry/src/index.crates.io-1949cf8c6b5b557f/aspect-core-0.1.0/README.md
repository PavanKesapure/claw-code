...
> - **Deployment**: See [DEPLOYMENT.md](DEPLOYMENT.md) for deploying to public repo
...
- Core AOP infrastructure with `Aspect` trait
- `#[aspect]` procedural macro for function weaving
- 8 production-ready aspects in `aspect-std`
...
- Advanced pointcuts: `execution()`, `within()`, `call()`, `field_access()`
...
See [`PHASE3_COMPLETE.md`](PHASE3_COMPLETE.md) for complete Phase 3 documentation.
...
- **[Phase 3 Design](PHASE3_COMPLETE.md)** - Future automatic weaving and advanced features
